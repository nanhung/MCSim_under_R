...
**Note:** The default PATH of Rtools is `"c:/Rtools/mingw_64/bin"`. If this is not the Rtools' PATH in your computer, pleaase assign the PATH to set it. For example, `set_PATH(PATH = "c:/Useres/Rtools/mingw_64/bin")`.
