...
- Additional code written by Ken Revzan allowed the definition and Bayesian calibration of hierarchical (multilevel) statistical models.
...
- Perform simulations across a randomly sampled region of the model parameter space. It can use to sample parameters from prior probability distributions.
...
Chiu and Bois (2007) - [An approximate method for population toxicoki netic analysis with aggregated data](https://link.springer.com/article/10.1198/108571107X229340) 

<hr>

Chiu et al. (2007) - [Toxicokinetics of Inhaled Trichloroethylene and Tetrachloroethylene in Humans at 1 ppm: Empirical Results and Comparisons with Previous Studies](https://academic.oup.com/toxsci/article/95/1/23/1690479)
...
.font120[The **Bayesian Markov chain Monte Carlo (MCMC) algorithm** is a effective way to do population PBPK model calibration. ]
...
.font180[**Our Problem Is ...**]

--

</br>

.font180[**How to Improve the .bolder[Computational Efficiency]**]
...
--
  ...
  (**Tempering in model calibration**)
...
1. .font120[What] is the best sensitivity analysis algorithm for PBPK model?

2. .font120[Dose] global sensitivity analysis better than "expert decision"?

3. .font120[Can] global sensitivity analysis provide the effective way in model calibration?
...
[Zurlinden and Reisfeld, 2016](https://link.springer.com/article/10.1007%2Fs13318-015-0253-x)
...
<img src="https://image.ibb.co/b9F8Ze/uSCphVE.gif" height="340px" />
